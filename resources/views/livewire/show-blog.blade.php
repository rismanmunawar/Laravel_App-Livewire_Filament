                ...
                <div class="col-lg-3">
                    ...
                    <div class="widget widget-categories">
                        ...
                        <ul class="list-unstyled widget-list">
                            ...
                            <li><a wire:navigate href="{{route('blogPage').'?categorySlug='.$category->slug}}">{{$category->name}} <small class="ml-auto">({{$category->articles()->count()}})</small></a>
                            </li>
                            @endforeach
                            @endif
                        </ul>
                    ...
                    <div class="widget">
                        ...
                        <ul class="list-unstyled widget-list">
                            ...
                            <li class="d-flex widget-post align-items-center">
                                <a wire:navigate class="text-black" href="{{route('blogDetail',$latestArticle->id)}}">
