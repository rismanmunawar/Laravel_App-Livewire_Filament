<main>
    <section class="section py-4">
        <div class="container" x-data="{
            categories: {
                'Getting Started': [
                    { title: 'Installation', content: 'Langkah-langkah instalasi Laravel...', video_url: 'https://youtu.be/example1' },
                    { title: 'Configuration', content: 'Cara konfigurasi awal aplikasi Laravel.' }
                ],
                'Deployment': {
                    'VPS Setup': [
                        { title: 'Install PHP di VPS', content: 'Gunakan apt atau yum untuk install PHP 8.2.' },
                        { title: 'Konfigurasi Nginx', content: 'Tambahkan server block untuk domain Anda.' }
                    ],
                    'CI/CD': {
                        'GitHub Actions': [
                            { title: 'Deploy Otomatis', content: 'Gunakan GitHub Actions untuk push ke server.' }
                        ]
                    }
                },
                'Troubleshooting': {
                    'Common Issues': [
                        { title: 'Error 500', content: 'Periksa log Laravel di storage/logs.' },
                        { title: 'Permission Denied', content: 'Pastikan folder memiliki hak akses yang benar.' }
                    ]
                }
            },
            selected: null
                    ...
                    <div class="p-4 bg-white rounded shadow-sm min-vh-50">
                        <template x-if="selected">
                            <div>
                                ...
                                <p class="text-muted small" x-text="selected.content"></p>
